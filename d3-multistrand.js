// Adapting d3-multichord to do multiple "strands"
// where each ribbon has a fixed width, but the color
// of the ribbon varies. This is meant to show different
// types of equally weighted, categorized connections 
...
(function (global, factory) {
	...
	function multichord(matrix) {
		...
		x0 = x, j = -1; while (++j < n) {
		    ...
		    var v = d3Array.sum(matrix[di][dj]);
